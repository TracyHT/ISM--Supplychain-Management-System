      ...
      <>
        ...
        >
          <Container>
            ...
            >
              <Box
                sx={{ width: { xs: "100%", lg: "60%" }, mb: { xs: 6, lg: 0 } }}
              >
                <Typography
                  variant="body1"
                  sx={{
                ...
                >
                  Welcome to our decentralized payment system, a next-generation
                  solution for secure, transparent, and efficient financial
                  transactions. Built on blockchain technology, our platform
                  eliminates the need for intermediaries, allowing users to send
                  and receive payments directly in their local currencies with
                  low fees and near-instant processing times. Our system
                  leverages smart contracts to automate and enforce payment
                  terms, ensuring trust and reliability in every transaction.
                  Whether you are a business or an individual, our decentralized
                  payment system empowers you to take control of your finances
                  in a fully decentralized, borderless environment. Experience
                  the future of payments today—where your money is truly yours.
                </Typography>
                <Box sx={{ mt: 5 }}>
                  <ConnectButton />
                </Box>
    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          ...
          <Paper
            elevation={6}
            sx={{ p: 6, mb: 10, backgroundColor: "rgba(0, 0, 0, 0.7)" }}
          >
          ...
          >
            ...
            <Typography variant="body1" sx={{ mb: 2 }}>
              ...
              {currentUserdetails?.balance
                ? `${parseFloat(
                    formatEther(currentUserdetails.balance)
                  ).toFixed(4)} ETH`
                : "0.0000 ETH"}
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              <strong>Address Of User:</strong>{" "}
              {currentUserdetails?.userAddress || "N/A"}
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              <strong>Status:</strong>{" "}
              {currentUserdetails?.isRegistered
                ? "Registered"
                : "Not Registered"}
            </Typography>
          </Paper>
