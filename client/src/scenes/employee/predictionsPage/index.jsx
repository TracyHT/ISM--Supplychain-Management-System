...
const PredictionPage = () => {
  ...
  const [activeProducts, setActiveProducts] = useState(['Laptop', 'Coffee_cup', 'Wireless_Headphones', 'Gaming_console']);
  const [viewType, setViewType] = useState("monthly");
  const currentYear = new Date().getFullYear();

  // Generate array of available years from 2000 to currentYear + 5
  const availableYears = Array.from({ length: currentYear + 6 - 2000 }, (_, i) => 2000 + i);
        ...
        <WidgetWrapper>
          ...
          <Grid container spacing={3} mb={4}>
            <Grid item xs={12} md={6}>
              <Card elevation={2}>
                <CardContent>
                  <Typography variant="h6" mb={2}>Prediction Year</Typography>
            ...
            <Grid item xs={12} md={6}>
              <Card elevation={2}>
                <CardContent>
                  <Typography variant="h6" mb={2}>View Settings</Typography>
                  <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <Box sx={{ flexGrow: 1 }}>
                      <Typography variant="body2" mb={1}>Product Filter</Typography>
                      <ToggleButtonGroup
                      ...
                      >
                        ...
                        <ToggleButton value="Coffee_cup">Coffee Cup</ToggleButton>
                        <ToggleButton value="Wireless_Headphones">Headphones</ToggleButton>
                        <ToggleButton value="Gaming_console">Console</ToggleButton>
                      </ToggleButtonGroup>
                    </Box>
                  </Stack>
                </CardContent>
            ...
            <CardContent sx={{ p: 0, '&:last-child': { pb: 0 } }}>
              {loading ? (
                <Box display="flex" justifyContent="center" alignItems="center" height="450px">
                  <CircularProgress />
                  <Typography ml={2} variant="body1">Loading prediction data...</Typography>
                </Box>
              ) : (
