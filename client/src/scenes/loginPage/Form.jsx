              ...
              <>
                ...
                {values.role === "supplier" && (
                  <TextField
                    ...
                    name="supplierId"
                    error={
                      Boolean(touched.supplierId) && Boolean(errors.supplierId)
                    }
                ...
                <TextField
                  ...
                  error={
                    Boolean(touched.securityQuestion) &&
                    Boolean(errors.securityQuestion)
                  }
                  helperText={
            ...
            {(isResetPasswordSecurity || isRegister) && (
              <>
                <TextField
                  ...
                  name="securityAnswer"
                  error={
                    Boolean(touched.securityAnswer) &&
                    Boolean(errors.securityAnswer)
                  }
